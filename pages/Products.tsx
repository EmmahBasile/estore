    ...
    <div className="flex flex-wrap -m-4">
      <div className="lg:w-1/4 md:w-1/2 p-4 w-full">
        ...
        <div className="mt-4">
          ...
          <h2 className="text-gray-100 title-font text-lg font-medium">The Catalyzer</h2>
          <p className="mt-1 text-gray-50 title-font">$16.00</p>
        </div>
      </div>
      <div className="lg:w-1/4 md:w-1/2 p-4 w-full">
        <a className="block relative h-48 rounded overflow-hidden">
        ...
        <div className="mt-4">
          <h3 className="text-gray-100 text-xs tracking-widest title-font mb-1">CATEGORY</h3>
          <h2 className="text-gray-100 title-font text-lg font-medium">Shooting Stars</h2>
          <p className="mt-1 text-gray-50 title-font">$21.15</p>
        </div>
      </div>
      <div className="lg:w-1/4 md:w-1/2 p-4 w-full">
        <a className="block relative h-48 rounded overflow-hidden">
        ...
        <div className="mt-4">
          <h3 className="text-gray-100 text-xs tracking-widest title-font mb-1">CATEGORY</h3>
          <h2 className="text-gray-100 title-font text-lg font-medium">Neptune</h2>
          <p className="mt-1 text-gray-50 title-font">$12.00</p>
        </div>
      </div>
      <div className="lg:w-1/4 md:w-1/2 p-4 w-full">
        <a className="block relative h-48 rounded overflow-hidden">
        ...
        <div className="mt-4">
          <h3 className="text-gray-100 text-xs tracking-widest title-font mb-1">CATEGORY</h3>
          <h2 className="text-gray-100 title-font text-lg font-medium">The 400 Blows</h2>
          <p className="mt-1 text-gray-50 title-font">$18.40</p>
        </div>
      </div>
      <div className="lg:w-1/4 md:w-1/2 p-4 w-full">
        <a className="block relative h-48 rounded overflow-hidden">
